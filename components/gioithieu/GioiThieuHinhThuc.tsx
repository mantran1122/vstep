    ...
    <section ref={rootRef} className="gtl">
      <div className="gtl-wrap">
        <header className="gtl-head">
          <h2 className="gtl-title gioithieu-main-title">Hình thức bài thi VSTEP bậc 3 – 5</h2>
        </header>
      ...
      <style jsx>{`
        ...
        .gtl-title {
          letter-spacing: -.03em; line-height: 1.14; color: var(--ink); margin: 0;
        }
        ...
        .vcard-num {
          font-family: var(--mono); font-size: calc(.72rem + 4px); font-weight: 600; letter-spacing: .2em;
        ...
        .vcard-tt { font-size: calc(1.08rem + 4px); font-weight: 500; color: var(--ink); margin: 0 0 8px; line-height: 1.32; }
        .vcard-foot {
          margin-top: auto; padding-top: 20px; border-top: 1px solid var(--divider);
          display: flex; align-items: center; justify-content: space-between;
        }
        .vcard-detail { font-family: var(--mono); font-size: calc(.68rem + 4px); letter-spacing: .08em; text-transform: uppercase; color: #c2bbac; }
        ...
        .fly-tt h4 { margin: 0; font-size: calc(1.02rem + 4px); font-weight: 600; color: var(--ink); line-height: 1.2; }
        .fly-tt span { font-family: var(--mono); font-size: calc(.66rem + 4px); color: #a89f8d; }
        .fly-x {
        ...
        .spec-row { display: flex; align-items: baseline; gap: 8px; font-size: calc(.78rem + 4px); }
        ...
        .spec-row .v { color: #2c2820; font-weight: 500; white-space: nowrap; font-family: var(--mono); font-size: calc(.74rem + 4px); }

        .parts { margin-bottom: 15px; }
        .parts-label { font-family: var(--mono); font-size: calc(.64rem + 4px); letter-spacing: .16em; text-transform: uppercase; color: var(--accent); margin: 0 0 9px; }
        ...
        .parts .pt { font-size: calc(.74rem + 4px); font-weight: 600; color: #3a352c; }
        .parts .pd { font-size: calc(.76rem + 4px); line-height: 1.5; color: #6a6256; }
        .desc { font-size: calc(.8rem + 4px); line-height: 1.68; color: #6a6256; margin: 0; padding-top: 14px; border-top: 1px solid #f0e9dc; }
