  ...
  return (
    <section ref={ref} className="py-16 lg:py-24">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
        <div className="grid grid-cols-2 gap-x-6 gap-y-12 lg:grid-cols-5 lg:gap-x-8">
          {STATS.map((stat, index) => (
            <div
              ...
              className={`flex flex-col items-start text-left lg:items-center lg:px-6 lg:text-center ${
            ...
            >
              <span
                ...
                style={{
                  ...
                  fontSize: 'clamp(calc(2.4rem + 4px), calc(4.2vw + 4px), calc(3.6rem + 4px))',
                }}
              >
                {formatStatValue(stat.value, stat.suffix, stat.decimals)}
              </span>
              <span className="mt-4 whitespace-nowrap text-[calc(0.82rem+4px)] font-semibold tracking-[0.08em] text-[#111]/65">
                {stat.label}
              </span>
            </div>
          ))}
